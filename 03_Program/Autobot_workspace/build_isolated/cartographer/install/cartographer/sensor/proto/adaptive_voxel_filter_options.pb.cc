...
static void InitDefaultsAdaptiveVoxelFilterOptions() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_AdaptiveVoxelFilterOptions =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsAdaptiveVoxelFilterOptions}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_AdaptiveVoxelFilterOptions.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/sensor/proto/adaptive_voxel_filter_options.proto", schemas, file_default_instances, TableStruct::offsets,
...
const AdaptiveVoxelFilterOptions& AdaptiveVoxelFilterOptions::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto::scc_info_AdaptiveVoxelFilterOptions.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* Arena::CreateMaybeMessage< ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions >(Arena* arena) {

...
static void InitDefaultsCeresSolverOptions() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_CeresSolverOptions =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsCeresSolverOptions}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_CeresSolverOptions.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/common/proto/ceres_solver_options.proto", schemas, file_default_instances, TableStruct::offsets,
...
const CeresSolverOptions& CeresSolverOptions::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto::scc_info_CeresSolverOptions.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::common::proto::CeresSolverOptions* Arena::CreateMaybeMessage< ::cartographer::common::proto::CeresSolverOptions >(Arena* arena) {

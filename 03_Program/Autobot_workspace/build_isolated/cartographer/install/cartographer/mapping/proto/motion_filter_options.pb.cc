...
static void InitDefaultsMotionFilterOptions() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_MotionFilterOptions =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsMotionFilterOptions}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_MotionFilterOptions.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/motion_filter_options.proto", schemas, file_default_instances, TableStruct::offsets,
...
const MotionFilterOptions& MotionFilterOptions::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2fmotion_5ffilter_5foptions_2eproto::scc_info_MotionFilterOptions.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::mapping::proto::MotionFilterOptions* Arena::CreateMaybeMessage< ::cartographer::mapping::proto::MotionFilterOptions >(Arena* arena) {

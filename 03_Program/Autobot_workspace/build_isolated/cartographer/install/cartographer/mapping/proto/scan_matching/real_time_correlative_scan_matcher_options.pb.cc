...
static void InitDefaultsRealTimeCorrelativeScanMatcherOptions() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_RealTimeCorrelativeScanMatcherOptions =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsRealTimeCorrelativeScanMatcherOptions}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_RealTimeCorrelativeScanMatcherOptions.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/scan_matching/real_time_correlative_scan_matcher_options.proto", schemas, file_default_instances, TableStruct::offsets,
...
const RealTimeCorrelativeScanMatcherOptions& RealTimeCorrelativeScanMatcherOptions::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto::scc_info_RealTimeCorrelativeScanMatcherOptions.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions* Arena::CreateMaybeMessage< ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions >(Arena* arena) {

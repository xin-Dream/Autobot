...
static void InitDefaultsFastCorrelativeScanMatcherOptions2D() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_FastCorrelativeScanMatcherOptions2D =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsFastCorrelativeScanMatcherOptions2D}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_FastCorrelativeScanMatcherOptions2D.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/scan_matching/fast_correlative_scan_matcher_options_2d.proto", schemas, file_default_instances, TableStruct::offsets,
...
const FastCorrelativeScanMatcherOptions2D& FastCorrelativeScanMatcherOptions2D::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f2d_2eproto::scc_info_FastCorrelativeScanMatcherOptions2D.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::mapping::scan_matching::proto::FastCorrelativeScanMatcherOptions2D* Arena::CreateMaybeMessage< ::cartographer::mapping::scan_matching::proto::FastCorrelativeScanMatcherOptions2D >(Arena* arena) {

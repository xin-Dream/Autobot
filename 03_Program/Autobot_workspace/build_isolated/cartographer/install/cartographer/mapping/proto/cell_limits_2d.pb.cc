...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/cell_limits_2d.proto", schemas, file_default_instances, TableStruct::offsets,
...
const CellLimits& CellLimits::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2fcell_5flimits_5f2d_2eproto::scc_info_CellLimits.base);

...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/probability_grid.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ProbabilityGrid& ProbabilityGrid::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto::scc_info_ProbabilityGrid.base);
